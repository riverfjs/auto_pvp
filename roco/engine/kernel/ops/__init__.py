...
``roco.engine.kernel.generation.gen_runtime_artifacts`` scans engine op modules and emits
``generated/runtime/handler_table.py`` with one ``from ... import ...`` per op function, so the
