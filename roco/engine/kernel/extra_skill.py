...
from roco.engine.kernel.damage import damage
...
from roco.engine.kernel.state import KernelState, replace_pet, replace_side, side, status_stack
from roco.engine.kernel.switch import faint_pet
