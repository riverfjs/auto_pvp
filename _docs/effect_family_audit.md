...
- count: **38** | coverage: `pak_ref` | used_consumer_count: 32
- editor_names: 三鼓作气, 专注力, 全属性, 全神贯注, 减速印记, 受伤, 吟游之弦, 属性强化, 恶魔的晚宴, 悼亡
- source_descriptions: 双攻、双防、速度属性+<span color="#FF4250">10%</>, 双攻、双防和速度+10%, 双攻和双防+20%, 双攻和双防永久+20%, 强化
- example_source_ids: [20010010, 20010014, 20010015, 20010020, 20010030]
- coverage_breakdown: {'pak_ref_count': 38, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7030490` 花炮 — 2连击，每次连击自己获得魔攻+60%。
    - `7000342` 熵增 — 全属性增加50%，使用后回复400绩点。
    - `7001191` 应对！潮汐 — 减伤60%，应对攻击：获得1层湿润印记。
    - `7020791` 应对！防反 — 减伤70%，应对攻击：自己获得物攻和魔攻+70%。
    - `7100251` 应对！龙血 — 减伤70%，本技能可以在蓄力状态下使用，应对攻击：下次技能无需蓄力。
- sample_ability_consumers:
    - `280014` 全神贯注 — 入场时，获得物攻+100%，每次行动后-20%。
    - `200149` 专注力 — 入场首回合，获得物攻+100%。
    - `7800507` 结晶水#7800507 — 初始能量为0，入场前其他精灵每放1次冰系技能，获得3能量。
...
- sample_skill_consumers:
    ...
    - `7130221` 应对！掩护 — 减伤70%，紧急脱离，应对攻击：下个入场精灵获得减伤。
- sample_ability_consumers:
...
- sample_skill_consumers:
    - `7080191` 应对！流沙 — 敌方3回合无法更换精灵，应对防御：敌方获得双防-60%。
    - `7080190` 流沙 — 敌方3回合无法更换精灵，应对防御：敌方获得双防-60%。
    - `7080150` 石锁 — 造成物伤，敌方3回合无法更换精灵。
- sample_ability_consumers:
    - `7000337` 药炉 — 无法更换，只能用这个炉子熬药！
    - `200286` 狂欢开始 — 钨丝贝贝/辉光幕机/机幕方舟会在背包里变化​出​随机​​精灵​，随机精灵只能与它们相互更换。入场后2回合无法换宠。
- pak_evidence:
...
- sample_skill_consumers:
    ...
    - `7030260` 孢子 — 敌方获得1层寄生。
    - `7030541` 应对！草1 — 造成魔伤，应对状态：赋予敌方一层寄生。
- pak_evidence:
...
- count: **5** | coverage: `pak_ref` | used_consumer_count: 1
- editor_names: 眩晕
...
- sample_skill_consumers:
    ...
    - `7030271` 应对！芳香诱引 — 自己获得连击数+2，应对防御：额外造成打断，且敌方下回合获得眩晕。
    - `7300001` 测试buff6 — 造成物伤
    - `7150170` 疾风涡轮 — 造成物伤，无法主动使用，在使用3次翼系技能后会自动使用此技能。
- sample_ability_consumers:
...
- count: **6** | coverage: `pak_ref` | used_consumer_count: 11
...
- coverage_breakdown: {'pak_ref_count': 6, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7040260` 引燃 — 敌方获得10层灼烧。
    - `7040290` 天火 — 敌方获得10层灼烧，应对防御：改为获得30层。
    - `7040291` 应对！天火 — 敌方获得10层灼烧，应对防御：改为获得30层。
    - `7120240` 疫病吐息 — 敌方获得1层中毒印记。
    - `7130170` 捆缚 — 敌方获得2层中毒，获得1次奉献：敌方获得2层中毒。
- sample_ability_consumers:
    - `7800507` 结晶水#7800507 — 初始能量为0，入场前其他精灵每放1次冰系技能，获得3能量。
    - `7800506` 恶魔叮 — 恶魔叮暂时还没有特性。
- pak_evidence:
...
- count: **9** | coverage: `pak_ref` | used_consumer_count: 6
...
- sample_skill_consumers:
    - `7900010` buff10 — 下个入场的精灵继承所有能力变化类效果
...
- count: **22** | coverage: `pak_ref` | used_consumer_count: 42
- editor_names: 绝对秩序, 逐魂鸟, 防御, 黑暗气息
- source_descriptions: 减伤, 受到的伤害-<span color="#73c715">50%</>。, 吸收, 身上散发着黑暗的力量，试试<span color="#73c715">光系精灵</>吧！
...
- sample_skill_consumers:
    ...
    - `7070271` 应对！相位移动 — 减​伤50%，​本技​能​位​于​1号​位​或​3号​位​时，​额​外减​伤40%，应对攻击，​传动1。​
    - `7070270` 相位移动 — 减​伤50%，​本技​能​位​于​1号​位​或​3号​位​时，​额​外减​伤40%，应对攻击，​传动1。​
    - `7100320` 守护咒 — 减​伤90%，​应对攻击。​​​巧变：龙系​状态技能。
    - `7100321` 应对！守护咒 — 减​伤90%，​应对攻击。​​​巧变：龙系​状态技能。
- sample_ability_consumers:
    - `200268` 绝对秩序 — 受到非敌方系别的技能攻击时伤害-50%。
    - `200127` 展翅 — 在场时，自己携带的普通系技能变为翼系技能。
...
- count: **51** | coverage: `mixed` | used_consumer_count: 25
...
- sample_skill_consumers:
    - `7110421` 应对！电磁偏转 — 减伤70%，应对攻击：下回合所选技能使用次数+1。
    - `7110281` 应对！集中 — 减伤80%，应对攻击：自己回合结束返场。
    - `7110360` 过载回路 — 回合结束自己返场，下回合所选技能使用次数+1。
    - `7140181` 应对！硬门 — 应对攻击：打断被应对技能，并造成90威力物伤。
    - `7130170` 捆缚 — 敌方获得2层中毒，获得1次奉献：敌方获得2层中毒。
- sample_ability_consumers:
    - `7800240` 首领免疫#7800240 — 免疫冰冻、吹飞，和中毒灼烧的伤害（给对手一个回合结束回满能量）
    ...
    - `200118` 结晶水#200118 — 初始能量为0，入场前己方精灵每放1次冰系技能，回复3能量。
- pak_evidence:
...
- count: **19** | coverage: `pak_ref` | used_consumer_count: 3
...
- sample_skill_consumers:
    ...
    - `7170151` 应对！报复 — 减伤70%，应对攻击：敌方失去3能量。
    - `7090341` 应对！冰蛋壳 — 减伤70%，应对攻击：敌方获得2层减速印记。
    - `7040301` 应对！火焰护盾 — 减伤70%，应对攻击：敌方获得6层灼烧。
    - `7080221` 应对！刺盾 — 减伤70%，应对攻击：敌方获得物攻-70%。
- sample_ability_consumers:
...
- count: **27** | coverage: `pak_ref` | used_consumer_count: 16
...
- sample_skill_consumers:
    - `7030570` 丛花陷阱 — S3半朽蜜果灵B
    - `7000347` 威压 — 下一次攻击技能威力翻倍
    - `7040271` 应对！热身 — 下一次攻击技能威力翻倍，应对防御：改为威力变为4倍。
    - `7020700` 伺机而动 — 下一次攻击时，技能威力+70。
    - `7040270` 热身 — 下一次攻击时，技能威力翻倍，应对防御：改为威力变为4倍。
- sample_ability_consumers:
...
- coverage_breakdown: {'pak_ref_count': 3, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7180331` 应对！虚假破产 — 减伤80%，能量不足时，消耗5%生命代替1能量，应对攻击。
    - `7180330` 虚假破产 — 减伤80%，能量不足时，消耗5%生命代替1能量，应对攻击。
...
- count: **16** | coverage: `pak_ref` | used_consumer_count: 12
...
- coverage_breakdown: {'pak_ref_count': 16, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7090320` 冰捆缚 — 2连击，每次连击敌方获得全技能能耗+1。
    - `7050230` 蓄水 — 下次使用的技能能耗-6。
    - `7050281` 应对！水环 — 减伤60%，应对攻击：自己获得全技能能耗-2。
    - `7001191` 应对！潮汐 — 减伤60%，应对攻击：获得1层湿润印记。
    - `7050461` 应对！水3 — 提高自身50%攻击，应对防御：下次释放技能能耗-5
- sample_ability_consumers:
...
- sample_skill_consumers:
    - `7170300` 入梦 — 敌方​下​回合回复的​能量​-5，​冷​却​2回合。
    - `7180350` 伪造账单 — 若敌方本回合回复生命，改为失去2倍。先手+1。
- pak_evidence:
...
- count: **22** | coverage: `pak_ref` | used_consumer_count: 11
...
- sample_skill_consumers:
    ...
    - `7140181` 应对！硬门 — 应对攻击：打断被应对技能，并造成90威力物伤。
    - `7120291` 应对！重金属粉尘 — 携带​的​攻击​技​能​获得​附加中毒3​，​应对防御：​改为​获得附加中毒6。
    - `7120290` 重金属粉尘 — 携带​的​攻击​技​能​获得​附加中毒3​，​应对防御：​改为​获得附加中毒6。
- sample_ability_consumers:
...
- sample_ability_consumers:
    - `200195` 化茧 — 受到致命伤害时，获得1层萌化，并免疫此次伤害。
...
- count: **15** | coverage: `pak_ref` | used_consumer_count: 6
- editor_names: 海象冰屋
...
- sample_skill_consumers:
    - `7120251` 应对！不可接触 — 减伤50%，敌方每有1层中毒效果，本技能减伤+10%，应对攻击。
    - `7160270` 击鼓传花 — 自己脱离，下个入场精灵继承自己增益。
    - `7080430` 地2 — 自身每有1层防御增益，获得1层对应的攻击增益
    - `7090430` 冰封 — 造​成​物伤，​敌方每有1层冻结，自己回复1能量。
    - `7160280` 月光合奏 — 造成物伤，1连击，双方携带的所有精灵每有1层萌化，本次技能连击数+1。
- sample_ability_consumers:
    - `200205` 月牙雪糕 — 使用攻击技能时，敌方每层冻结视为1层额外星陨印记。
...
- count: **7** | coverage: `pak_ref` | used_consumer_count: 6
- editor_names: 暴风眼, 连击
...
- sample_skill_consumers:
    - `7030500` 聚盐 — 2连击，每次连击自己回复8%生命，使用后本技能连击数永久+1。
    - `7150311` 应对！羽翼庇护 — 减伤70%，应对攻击：自己获得连击数+2。
    - `7021050` 耀眼 — 敌方获得连击数-4。
    - `7030271` 应对！芳香诱引 — 自己获得连击数+2，应对防御：额外造成打断，且敌方下回合获得眩晕。
    - `7030270` 芳香诱引 — 自己获得连击数+2，应对防御：额外造成打断，且敌方下回合获得眩晕。
- pak_evidence:
...
- count: **9** | coverage: `pak_ref` | used_consumer_count: 8
...
- sample_skill_consumers:
    ...
    - `7120110` 感染病 — 造成魔伤，若击败敌方则将中毒转化为中毒印记。
- sample_ability_consumers:
...
- count: **17** | coverage: `pak_ref` | used_consumer_count: 10
...
- sample_skill_consumers:
    - `7110370` 远程访问 — 使敌方精灵返场。
    - `7080251` 应对！遁地 — 减伤50%并脱离，应对攻击。
    - `7080250` 遁地 — 减伤50%并脱离，应对攻击。
    - `7130221` 应对！掩护 — 减伤70%，紧急脱离，应对攻击：下个入场精灵获得减伤。
    - `7130220` 掩护 — 减伤70%，紧急脱离，应对攻击：下个入场精灵获得减伤。
- pak_evidence:
...
- sample_skill_consumers:
    ...
    - `7170140` 降灵 — 敌方获得1层降灵印记。
    - `7110270` 加大功率 — 自己脱离，替换入场的精灵回复8能量。
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 5, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7100150` 升龙咆哮 — 蓄力，对敌方造成魔法伤害。
    - `7100170` 龙吟 — 蓄力，自己获得双攻+150%和速度+80。
    - `7100160` 龙之利爪 — 蓄力，造成物伤并吸血50%。
    - `7100130` 吹炎 — 蓄力，造成物伤，应对状态：本次技能威力翻倍。
    - `7100131` 应对！吹炎 — 蓄力，造成物伤，应对状态：本次技能威力翻倍。
- sample_ability_consumers:
...
- coverage_breakdown: {'pak_ref_count': 2, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7180211` 应对！等价交换 — 减伤90%，应对攻击：自己获得50%吸血。
    - `7180160` 贪婪 — 自己获得100%吸血。
- sample_ability_consumers:
...
- count: **1** | coverage: `pak_ref` | used_consumer_count: 5
- editor_names: 冻结
- source_descriptions: 冻结5%生命，若当前生命低于冻结比例，则力竭。（冰系精灵免疫此效果）
- example_source_ids: [20580010]
- coverage_breakdown: {'pak_ref_count': 1, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7090190` 霜天 — 敌方获得1层冻结，且每有1层冻结获得全技能能耗+1。
    - `7090160` 霜降 — 敌方获得4层冻结。
    - `7090400` 冰点 — 敌方获得5层冻结，应对防御：额外获得5层。
    - `7090401` 应对！冰点 — 敌方获得5层冻结，应对防御：额外获得5层。
    - `7090440` 寒潮 — 造成​魔伤，​敌方​获得​1层​冻结，应对状态：额​外​获得4层​冻结，​​巧变：​冻结相关技​能​。
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 1, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7140161` 应对！破防 — 敌方获得双防-70%，应对防御：额外使被应对技能冷却2回合。
- pak_evidence:
...
- sample_skill_consumers:
    ...
    - `7190320` 心灵洞悉 — 敌方获得星陨印记，获得层数等于敌方印记层数。
...
- count: **33** | coverage: `pak_ref` | used_consumer_count: 11
...
- sample_skill_consumers:
    - `7070250` 减压阀 — 主动：​本技​能​被​动永久额​外​+20​威力，​被动：​两​侧​技​能​威力​+10，​传动1。
    - `7070060` 轴承支撑 — 主动：本技能被动永久额外-1能耗，被动：两侧技能能耗-1，传动1。
    - `7070071` 应对！联动装置 — 使用后两侧技能的威力永久+20，应对防御：变为威力永久+30。
    - `7070070` 联动装置 — 使用后两侧技能的威力永久+20，应对防御：变为威力永久+30。
    - `7070271` 应对！相位移动 — 减​伤50%，​本技​能​位​于​1号​位​或​3号​位​时，​额​外减​伤40%，应对攻击，​传动1。​
- sample_ability_consumers:
...
- count: **17** | coverage: `pak_ref` | used_consumer_count: 8
...
- sample_skill_consumers:
    ...
    - `7110380` 感电 — 造成魔伤，每离场1次，本技能使用次数永久+1。
- sample_ability_consumers:
    - `200230` 不朽 — 力竭3回合后复活。
    - `200231` 孤傲 — 敌方精灵离场后，其增益和减益会被更换入场的精灵继承。
    - `200163` 快充 — 离场时回复10能量。
...
- coverage_breakdown: {'pak_ref_count': 3, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7060270` 色散 — 造成魔伤，对​混血精灵造成​伤害​+50%。
- sample_ability_consumers:
    - `200192` 绒粉星光 — 攻击时，若敌方血脉是非本系的系别血脉，技能威力+100%。
...
- editor_names: buff77
- source_descriptions: 能耗每比基础配置低1，威力+10
- example_source_ids: [20770010, 20770030, 20770090, 20770100, 20770110]
- coverage_breakdown: {'pak_ref_count': 6, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7900040` buff77 — 获得此buff后，能耗每低于基础配置1点，威力+10
- sample_ability_consumers:
...
- coverage_breakdown: {'pak_ref_count': 3, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7190260` 多维击打 — 造成魔伤，1连击，敌方每有1层星陨印记，本次技能连击数+1。
- sample_ability_consumers:
...
- count: **13** | coverage: `pak_ref` | used_consumer_count: 10
- editor_names: 蓄电印记
...
- sample_skill_consumers:
    - `7900060` buff93 — 你的攻击技能获得迸发：以触发过的随机一种迸发，回合末返场
    - `7110260` 增程电池 — 自己获得1层蓄电印记。
    - `7110180` 电弧 — 造成物伤，迸发：本次技能威力+40。
    - `7020980` 天旋地转 — 造成物理伤害，先手+1，迸发：本次技能威力+30。
    - `7110210` 引雷 — 造成魔伤，2连击，迸发：本次技能威力+20。
- sample_ability_consumers:
    - `280014` 全神贯注 — 入场时，获得物攻+100%，每次行动后-20%。
    - `200149` 专注力 — 入场首回合，获得物攻+100%。
...
- coverage_breakdown: {'pak_ref_count': 2, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7190300` 星链 — 2连击，每次连击使敌方获得1层星陨印记。
    - `7190290` 星轨裂变 — 敌方获得2层星陨印记。
    - `7190310` 超新星馈赠 — 敌方获得2层星陨印记，每使用1次，赋予的星陨印记层数永久+1。
    - `7190330` 二律背反 — 敌方获得3层星陨印记，应对防御：额外使敌方星陨印记层数翻倍。
...
- sample_skill_consumers:
    - `7020770` 退化 — 敌方获得1层萌化。
    - `7160200` 甜心续航 — 自己和敌方获得萌化：回复40%生命和4能量。
    - `7160180` 赤子之心 — 自己获得萌化：全技能能耗永久-3。
    - `7160170` 示弱 — 自己获得萌化：速度永久+150。
    - `7160311` 应对！萌2 — 赋予敌方一层萌化，应对防御：额外赋予一层。
- pak_evidence:
...
- count: **10** | coverage: `pak_ref` | used_consumer_count: 9
...
- sample_skill_consumers:
    ...
    - `7110251` 应对！麻痹 — 敌方先手-1，应对防御：额外使敌方获得双攻-70%。
    - `7110250` 麻痹 — 敌方先手-1，应对防御：额外使敌方获得双攻-70%。
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 2, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7900050` buff109 — 获得此buff后，回复生命值变为扣除敌方等量生命
- sample_ability_consumers:
...
- sample_skill_consumers:
    - `7900070` buff111 — 获得此buff后，场上的灼烧衰减后会变为等量的中毒
- sample_ability_consumers:
...
- count: **1** | coverage: `pak_ref` | used_consumer_count: 7
...
- sample_skill_consumers:
    ...
    - `7070060` 轴承支撑 — 主动：本技能被动永久额外-1能耗，被动：两侧技能能耗-1，传动1。
    - `7070270` 相位移动 — 减​伤50%，​本技​能​位​于​1号​位​或​3号​位​时，​额​外减​伤40%，应对攻击，​传动1。​
    - `7070170` 啮合传递 — 自己获得速度+30，本技能位于1号或3号位时额外获得物攻+80%，传动1。
    - `7070120` 传感器 — 造成物伤，2连击，本技能位于1号或3号位时连击+1，传动1。
- pak_evidence:
...
- count: **10** | coverage: `pak_ref` | used_consumer_count: 5
- example_source_ids: [21170010, 21170030, 21170070, 21170080, 21170090]
- coverage_breakdown: {'pak_ref_count': 10, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7070120` 传感器 — 造成物伤，2连击，本技能位于1号或3号位时连击+1，传动1。
    - `7070010` 械斗 — 造成物伤，本技能位于1号位时威力+60，传动1。
    - `7070040` 钢铁洪流 — 造成物伤，本技能位于1号位时威力+90，传动2。
    - `7070150` 齿轮切开 — 造成物伤，本技能位于1号或3号位时能耗-2，传动1。
    - `7070180` 机械1 — 造成魔伤，威力增加10*X，X为技能位置，传动1。
- pak_evidence:
...
- sample_skill_consumers:
    - `7030600` 凝翠 — S3森巨人B
    - `7030551` 应对！空灵斗士草1 — 造成物伤，应对状态：本次攻击受攻击属性增益影响翻倍
    - `7050471` 应对！水星水1 — 造成魔伤，应对状态：本次伤害不受自身属性减益和敌方属性增益影响
- sample_ability_consumers:
...
- sample_skill_consumers:
    ...
    - `7160180` 赤子之心 — 自己获得萌化：全技能能耗永久-3。
    - `7160170` 示弱 — 自己获得萌化：速度永久+150。
    - `7160140` 超级糖果 — 造成物伤，自己获得萌化：本次技能威力+60。
    - `7160250` 撒娇 — 造成魔伤，3连击。自己获得萌化：威力永久+20。
- sample_ability_consumers:
    - `200195` 化茧 — 受到致命伤害时，获得1层萌化，并免疫此次伤害。
- pak_evidence:
...
- count: **11** | coverage: `pak_ref` | used_consumer_count: 0
- example_source_ids: [21460010, 21460200, 21460210, 21460230, 21460260]
- coverage_breakdown: {'pak_ref_count': 11, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7050510` 清洗 — ​驱散​自己​的​减益，​自己​每​有​1层减益，​本技​能​能​耗​-1，巧变：​水系​攻击​技​能​。
    - `7900090` buff146 — 使用此技能后，变为随机水系攻击技能
    - `7100320` 守护咒 — 减​伤90%，​应对攻击。​​​巧变：龙系​状态技能。
    - `7100321` 应对！守护咒 — 减​伤90%，​应对攻击。​​​巧变：龙系​状态技能。
    - `7120301` 应对！毒肽 — 减伤70%，巧变：毒系状态技能，应对攻击。
- pak_evidence:
    - BUFF_CONF.json: 21460010 buff_base_ids=[2146001] name='' desc=''
    - BUFF_CONF.lua confirms field schema (id/buff_base_ids/desc/...)

## `buff_conf_direct:prefix_2147` — BUFF_CONF_DIRECT

- count: **1** | coverage: `pak_ref` | used_consumer_count: 0
- editor_names: buff147
- source_descriptions: 每回合结束时造成伤害最高的精灵获得一层中毒
- example_source_ids: [21470010]
- coverage_breakdown: {'pak_ref_count': 1, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7900100` buff147 — 获得此buff后，每回合结束时造成伤害最高的精灵获得1中毒
- pak_evidence:
    - BUFF_CONF.json: 21470010 buff_base_ids=[2147001] name='buff147' desc='每回合结束时造成伤害最高的精灵获得一层中毒'
    - BUFF_CONF.lua confirms field schema (id/buff_base_ids/desc/...)
...
- coverage_breakdown: {'pak_ref_count': 1, 'gap_count': 0, 'ability_flag_count': 0}
- sample_ability_consumers:
    - `200275` 合拍 — 当回合自己与敌方使用的技能相似度越高，回合结束时获得越多双攻和双防增益。
- pak_evidence:
...
- count: **10** | coverage: `pak_ref` | used_consumer_count: 4
- editor_names: 渴求
- example_source_ids: [1011001, 1011003, 1011004, 1011005, 1011006]
- coverage_breakdown: {'pak_ref_count': 10, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7990129` 检测工具用 — 应对！检测工具攻击
    - `7990128` 检测工具攻击 — 检测工具用
    - `7100160` 龙之利爪 — 蓄力，造成物伤并吸血50%。
    - `7180121` 应对！暗突袭 — 造成物伤，吸血50%，应对状态：本次技能威力翻倍。
    - `7180120` 暗突袭 — 造成物伤，吸血50%，应对状态：本次技能威力翻倍。
- pak_evidence:
...
- count: **40** | coverage: `pak_ref` | used_consumer_count: 19
...
- sample_skill_consumers:
    ...
    - `7050280` 水环 — 减伤60%，应对攻击：自己获得全技能能耗-2。
    - `7020790` 防反 — 减伤70%，应对攻击：自己获得物攻和魔攻+70%。
    - `7030330` 蜡质膜 — 减伤80%，应对攻击：回复3能量。
- pak_evidence:
...
- count: **12** | coverage: `pak_ref` | used_consumer_count: 40
...
- sample_skill_consumers:
    ...
    - `7180371` 应对！小光恶1 — 造成魔伤，应对状态：自身立即使用一次被应对技能
- pak_evidence:
...
- count: **92** | coverage: `pak_ref` | used_consumer_count: 3
...
- count: **17** | coverage: `pak_ref` | used_consumer_count: 2
- editor_names: 蚀刻
- example_source_ids: [1042001, 1042002, 1042003, 1042004, 1042005]
- coverage_breakdown: {'pak_ref_count': 17, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7120130` 毒雾 — 将敌方所有增益，转化成中毒。
    - `7040470` 焚毁 — 造成魔伤，驱散敌方所有印记，每驱散1层，获得物攻+20%。
    - `7040680` 焚尽 — 驱散​自己​所有印记，​每驱散1层，获得物攻+50%。​巧变：​火系​攻击​技​能​。
    - `7040500` 焚烧烙印 — 驱散双方所有印记，每驱散1层，敌方获得5层灼烧。
- sample_ability_consumers:
    - `280019` 御驾亲征 — 棋契陛下大幅提升种族资质，力竭时扣除4魔力。
    - `280021` 先知 — 若敌方技能足够击败自己，回合开始时自己获得速度+50，双攻+50%。
- pak_evidence:
...
- count: **29** | coverage: `pak_ref` | used_consumer_count: 8
...
- sample_skill_consumers:
    - `7030500` 聚盐 — 2连击，每次连击自己回复8%生命，使用后本技能连击数永久+1。
    - `7030570` 丛花陷阱 — S3半朽蜜果灵B
    - `7030321` 应对！酶浓度调整 — 减伤80%，应对攻击：自己回复20%生命。
...
- sample_skill_consumers:
    - `7160190` 反弹 — 将自己的萌化转移给敌方。
    - `7130291` 应对！翅刃 — 造成物伤，驱散敌方所有印记，应对状态：改为偷取印记。
    - `7040500` 焚烧烙印 — 驱散双方所有印记，每驱散1层，敌方获得5层灼烧。
- pak_evidence:
...
- count: **3** | coverage: `pak_ref` | used_consumer_count: 5
- example_source_ids: [1051001, 1051002, 1051003]
- coverage_breakdown: {'pak_ref_count': 3, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7150151` 应对！风墙 — 减伤50%，迅捷，应对攻击。
    - `7150150` 风墙 — 减伤50%，迅捷，应对攻击。
    - `7150300` 羽化加速 — 自己获得全技能威力+20，迅捷。
    - `7150260` 飞羽 — 迅捷，驱散敌方1种增益。
    - `7150111` 应对！龙卷风 — 造成物伤，迅捷，应对状态：本次技能威力变为1.5倍。
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 9, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7120160` 落井下毒 — 使敌方精灵减益的层数翻倍。
    - `7080201` 应对！泥浆铠甲 — 自己获得物攻和物防+60%，应对防御：额外使自己的增益翻倍。
    - `7140321` 应对！格斗小七2 — 造成魔伤，应对状态：自身魔攻增益翻倍
    - `7090141` 应对！极寒领域 — 造成魔伤，若敌方有冻结，本次技能威力+60，应对状态：使冻结翻倍。
    - `7160160` 生日蛋糕 — 驱散自己的减益，自己的增益翻倍。
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 17, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7040280` 充分燃烧 — 使敌方身上的灼烧翻倍，并触发1次灼烧伤害。
    - `7999111` 抹除存在 — 击败所有没有名字的精灵。
    - `7120230` 腐化 — 敌方每有1层中毒效果，敌方获得双攻-30%。
    - `7120150` 以毒攻毒 — 敌方每有1层中毒效果，自己获得魔攻+30%。
    - `7001171` 应对！二律背反 — 敌方获得3层星陨，应对防御：额外使敌方星陨层数翻倍。
- pak_evidence:
...
- sample_skill_consumers:
    ...
    - `7021161` 应对！摇篮曲 — 敌方获得全技能能耗+3，应对防御：额外造成打断，且敌方下回合获得眩晕。
    - `7030271` 应对！芳香诱引 — 自己获得连击数+2，应对防御：额外造成打断，且敌方下回合获得眩晕。
    - `7180361` 应对！恶1 — 造成大量魔伤，降低自身60%魔防，应对状态：改为降低敌方60%魔防
- pak_evidence:
...
- count: **106** | coverage: `pak_ref` | used_consumer_count: 48
...
- sample_skill_consumers:
    - `7030590` 硕果 — S3森巨人A
    - `7030580` 花瓣群舞 — S3炮米花B
    - `7030560` 草光冲击 — S3雪影娃娃·春日B
    - `7040270` 热身 — 下一次攻击时，技能威力翻倍，应对防御：改为威力变为4倍。
    - `7170270` 幽1 — 使双方失去8能量，应对防御：自身不失去能量。
- pak_evidence:
...
- count: **65** | coverage: `pak_ref` | used_consumer_count: 9
...
- sample_skill_consumers:
    - `7180180` 欺诈契约 — 与敌方交换增益和减益。
    - `7150260` 飞羽 — 迅捷，驱散敌方1种增益。
    - `7130290` 翅刃 — 造成物伤，驱散敌方所有印记，应对状态：改为偷取印记。
    - `7050441` 应对！水1 — 造成魔伤，应对状态：驱散敌方增益
    - `7021170` 倾泻 — 造成魔伤，若本次攻击未被防御技能应对，则驱散双方所有印记。
- sample_ability_consumers:
    - `280017` 宝剑王牌 — 仅可使用1号和3号位技能。
    - `280008` 高浓生物碱 — 使用技能时，敌方获得2层中毒。
    - `280001` 浪潮 — 使用水系技能后，全技能能耗-2。
...
- count: **13** | coverage: `pak_ref` | used_consumer_count: 2
- example_source_ids: [1053003, 1053008, 1053009, 1053010, 1053011]
- coverage_breakdown: {'pak_ref_count': 13, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7090190` 霜天 — 敌方获得1层冻结，且每有1层冻结获得全技能能耗+1。
    - `7130310` 食腐 — 驱散敌方印记，每层印记回复自己10%生命。
- pak_evidence:
...
- count: **20** | coverage: `pak_ref` | used_consumer_count: 1
- editor_names: 振奋虫心
...
- sample_skill_consumers:
    - `7130321` 应对！虫结阵 — 减伤80%，应对攻击：己方队伍获得1次随机奉献。
    - `7130200` 虫群智慧 — 己方队伍获得2次随机奉献。
    - `7190430` 叠加态 — 自己获得​随机​16层属性增益​，​巧变：​幻系攻击​技​能​。
- sample_ability_consumers:
    - `280012` 抓到你了 — 自己入场时敌方获得2层冻结，使敌方获得冻结时，也会使其获得全技能能耗+1。
- pak_evidence:
...
- count: **52** | coverage: `pak_ref` | used_consumer_count: 11
...
- sample_skill_consumers:
    ...
    - `7170270` 幽1 — 使双方失去8能量，应对防御：自身不失去能量。
    - `7170271` 应对！幽1 — 使双方失去8能量，应对防御：自身不失去能量。
- sample_ability_consumers:
    - `280007` 地脉馈赠 — 突破能量上限并立即回复10能量，入场前己方精灵每放1次地系技能，回复3能量。
- pak_evidence:
...
- count: **5** | coverage: `pak_ref` | used_consumer_count: 3
- example_source_ids: [1028001, 1028002, 1028003, 1028004, 1028005]
- coverage_breakdown: {'pak_ref_count': 5, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7090370` 冬至 — 将天气改为暴风雪，持续8回合。
    - `7080210` 沙涌 — 将天气改为沙暴，持续8回合。
    - `7050250` 落雨 — 将天气改为雨天，持续8回合。
...
- count: **64** | coverage: `pak_ref` | used_consumer_count: 30
...
- sample_skill_consumers:
    ...
    - `7080250` 遁地 — 减伤50%并脱离，应对攻击。
    - `7150150` 风墙 — 减伤50%，迅捷，应对攻击。
    - `7140190` 听桥 — 减伤60%，应对攻击：对敌方造成物理伤害，威力与被应对技能相等。
    - `7020780` 防御 — 减伤70%，应对攻击。
- pak_evidence:
...
- count: **3** | coverage: `pak_ref` | used_consumer_count: 42
...
- sample_skill_consumers:
    ...
    - `7100320` 守护咒 — 减​伤90%，​应对攻击。​​​巧变：龙系​状态技能。
    - `7100321` 应对！守护咒 — 减​伤90%，​应对攻击。​​​巧变：龙系​状态技能。
    - `7020811` 应对！无畏之心 — 减伤100%，应对攻击：减免的伤害变为回复自己生命，且本技能能耗永久+2。
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 20, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7900120` effect38 — 若场下精灵是草系或草血脉，则获得中毒
- pak_evidence:
...
- count: **8** | coverage: `pak_ref` | used_consumer_count: 2
...
- coverage_breakdown: {'pak_ref_count': 2, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7900130` effect74 — 其他技能基础能耗变为此技能能耗
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 2, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7130151` 应对！虫击 — 造成物伤，应对状态：本次技能威力变为2倍，无视敌方系别抵抗。
- pak_evidence:
...
- sample_skill_consumers:
    - `7100251` 应对！龙血 — 减伤70%，本技能可以在蓄力状态下使用，应对攻击：下次技能无需蓄力。
    - `7100250` 龙血 — 减伤70%，本技能可以在蓄力状态下使用，应对攻击：下次技能无需蓄力。
    - `7000011` 积蓄 — 可继续蓄力一回合，最终技能释放次数+1。
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 1, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7070290` 过山车 — 使己方队伍中的所有精灵携带的技能跨精灵向下移动1个位置。
    - `7900140` effect87 — 使用后，所有精灵的技能跨精灵传递一次
- pak_evidence:
...
- coverage_breakdown: {'pak_ref_count': 2, 'gap_count': 0, 'ability_flag_count': 0}
- sample_skill_consumers:
    - `7180440` 假冒 — 自己的生命比例变为与敌方生命比例相同，巧变：恶系攻击技能。
    - `7900150` effect88 — 自身血量百分比变为敌方生命百分比
- pak_evidence:
