...
Total `buffbase_order` families: **128**.  `buffbase_order rule` is the post-7C primary axis (`buffbase_order_handlers.jsonl`); `prefix rule` is the legacy axis kept only for the 3 mixed prefixes whose buffbase_order distribution is not 100% concentrated.
...
| **133** | 2 | 2:2 | — | `H_SELF_BUFF` (FROG) | — | 1 | 上岸蛙 |
| **134** | 1 | 3:1 | — | `H_SELF_BUFF` (SEGMENT_HP) | — | 1 | 分段血量 |
| **135** | 1 | 2:1 | — | `H_BURN` (HIT_BURN) | — | 1 | 连击加灼烧 |
| **136** | 2 | 1:2 | — | `H_CUTE_GAIN` (CUTE_INFINITE) | — | 2 | 无限萌化, 萌化不降低种族资质 |
| **138** | 5 | 3:5 | — | `H_CLEANSE` (PURIFY) | — | 5 | 小光1淳朴, 小光2淳朴, 水星龙弦技能1_效果1 |
| **139** | 1 | 2:1 | — | — | — | 1 | 纯净 |
| **140** | 1 | 0:1 | — | — | — | 1 | 剧情--捕捉魔法 |
| **141** | 1 | 3:1 | — | `H_PASSIVE_ENERGY_REDUCE` (COST_EFFICIENCY) | — | 1 | 能耗变化效率翻倍 |
| **142** | 7 | 1:7 | — | `H_CUTE_GAIN` (CANDY) | — | 7 | 撒娇, 检测能否继续萌化, 甜心续航 |
| **143** | 12 | 7:12 | — | `H_SELF_BUFF` (MARK_CHANGE) | — | 12 | 改变赋予印记鲤拉鳐 |
