...
HANDLERS: tuple = (
    ...
    op_entry_element_skill_mod_by_count,  # 53
    op_entry_energy_from_counter_count,  # 54
    op_entry_energy_from_element_count,  # 55
    op_entry_self_buff_by_side_count,  # 56
    op_entry_self_buff_by_source_count,  # 57
    op_entry_self_buff_by_used_skill_count,  # 58
    op_entry_self_buff_if_energy,  # 59
    op_entry_self_damage,  # 60
    op_exchange_hp_ratio,  # 61
    op_exchange_moves,  # 62
    op_first_strike_hit_count,  # 63
    op_force_enemy_switch,  # 64
    op_force_switch,  # 65
    op_freeze,  # 66
    op_grant_life_drain,  # 67
    op_heal_energy,  # 68
    op_heal_hp,  # 69
    op_heal_on_grass_skill,  # 70
    op_hit_count_by_team_skill_count,  # 71
